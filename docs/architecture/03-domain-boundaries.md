...
| Customer Management      | `customers`      | Customer profiles, contacts, interaction history, attachment metadata    | Binary content is in object storage. Customers are anonymized in place, never hard-deleted, so ticket/SLA history survives. |
