/**
 * Story 171 — mirrors `apps/web/src/hooks/use-navigating-router.spec.ts`,
 * which is the file this app's hook was ported from.
 */
...
describe("useNavigatingRouter (portal)", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
