...
/**
 * UX audit — the boundary that actually covers `(customer)/layout.tsx`'s
 * blocking `fetchCurrentContact()` call (see this file's own doc comment
 * for why none of the per-route `loading.tsx` files could). Same shared
