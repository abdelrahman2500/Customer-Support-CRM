 ...
 * Story 139 — surfaces now render through the shared `Card`. Each panel keeps
 * its own `<section>` landmark via `Card asChild`, so the page's structure is
 * unchanged and only the surface styling is centralised.
 */
