...
//
// Story S-1 — deliberately a copy of apps/web/tailwind.config.ts, not a
// shared import: extracting the shared design layer into a workspace
// package is Story S-2, and doing it here would mean this story owned two
// migrations at once. The two files must be kept in step until then.
